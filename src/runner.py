...
commands = [
    "python train.py --opt lion  --weight-decay 0.001  --lr 0.0001 -b 128 --experiment-name lion-resnet18-b128-0001-original      --epochs 80 --lr-scheduler cosineannealinglr --momentum 0.90 --model resnet18_custom --dataset CIFAR100",
    ...
    "python train.py --opt adam  --weight-decay 0.0001 --lr 0.001  -b 256 --experiment-name adam-resnet18-b256-original           --epochs 80  --lr-scheduler cosineannealinglr --momentum 0.90 --model resnet18_custom --dataset CIFAR100",
    ...
    "python train.py --opt asam-adam --weight-decay 0.0001 --lr 0.001  -b 256 --experiment-name asam-adam-resnet18-b256-original  --epochs 200 --lr-scheduler cosineannealinglr --momentum 0.90 --model resnet18_custom --dataset CIFAR100",
